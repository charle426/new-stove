...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-7 w-max items-center justify-center rounded-md bg-background px-[6px] lg:px-4 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50"
)
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ...
    className={cn(
      "left-0 absolute",
      "absolute top-full w-fit bg-popover mt-[5px] shadow-lg border rounded-lg px-3 z-[1000]",
